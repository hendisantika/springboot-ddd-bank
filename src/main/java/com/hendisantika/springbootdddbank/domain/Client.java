...
public class Client extends EntityBase<Client> {
     ...
     *
     * @param destination number of the {@link Account} where the given {@link Amount} will
     *                    be deposited.
     * @param amount      the {@link Amount} which will be deposited
     * @throws AmountExc                     Illegal amount (negative or zero)
     * @throws DestinationAccountNotFoundExc No account with the given destination account number is found.
     ...
     * destination account.
     *
     * @param source      the {@link Account} from which the {@link Amount} will be taken
     * @param destination Number of the {@link Account} to which the {@link Amount} will be
     *                    transfered
     * @param amount      the {@link Amount} to be transfered
     * @throws WithoutRightExc               The sender is not a manager of the source account.
     * @throws AmountExc                     Illegal amount (negative or zero)
     * @throws MinimumBalanceExc             The source account's balance would fall under the minimum
     *                                       balance.
     * @throws DestinationAccountNotFoundExc No account with the given destinationAccountNo is found.
     */
     ...
     * @throws DestinationAccountNotFoundExc No account with the given account number is found.
     */
     ...
     * @throws NotManagedAccountExc Account with the given accountNo is neither owned nor managed by
     *                              this {@link Client}.
     */
