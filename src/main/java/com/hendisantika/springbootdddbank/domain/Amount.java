...
public class Amount {
     ...
     *
     * @param euros number of EUR
     * @param cents number of EUR cents
     */
     ...
     *
     * @param euros an amount of EUR given as a floating point value
     * @throws RangeExc                 the given EURvalue is less than {@link #minValue()} or greater
     *                                  than {@link #maxValue()}
     ...
     *
     * @param other the other {@link Amount} to be added to this one
     ...
     *
     * @param other the other {@link Amount} which will be subtracted from this one
     ...
     *
     * @param factor the factor by which this {@link Amount} has to be multiplied
     * @return the product
     * @throws IllegalArgumentException the resulting value is out of range
     */
